...
type AppendEntryMessage struct {
	...
	LeaderAddressIndex int64                  `protobuf:"varint,2,opt,name=leaderAddressIndex,proto3" json:"leaderAddressIndex,omitempty"`
...
func (x *AppendEntryMessage) GetLeaderAddressIndex() int64 {
	if x != nil {
		return x.LeaderAddressIndex
	}
	return 0
}
...
type RequestVoteMessage struct {
	...
	ServerIndex   int64                  `protobuf:"varint,4,opt,name=serverIndex,proto3" json:"serverIndex,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RequestVoteMessage) GetServerIndex() int64 {
	if x != nil {
...
const file_server_proto_rawDesc = "" +
	"\n" +
	"\fserver.proto\x12\x0fserverMessaging\"\xf3\x01\n" +
	"\x12AppendEntryMessage\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x03R\x04term\x12.\n" +
	"\x12leaderAddressIndex\x18\x02 \x01(\x03R\x12leaderAddressIndex\x12\"\n" +
	"\fprevLogIndex\x18\x03 \x01(\x03R\fprevLogIndex\x12 \n" +
	"\vprevLogTerm\x18\x04 \x01(\x03R\vprevLogTerm\x12/\n" +
	"\x05entry\x18\x05 \x01(\v2\x19.serverMessaging.LogEntryR\x05entry\x12\"\n" +
	...
	"\vlastLogTerm\x18\x03 \x01(\x03R\vlastLogTerm\x12 \n" +
	"\vserverIndex\x18\x04 \x01(\x03R\vserverIndex\"K\n" +
